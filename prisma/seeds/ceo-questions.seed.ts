...
export const strategyQuestions: CEOQuestion[] = [
    ...
    },
    {
        ...
        dimensionKey: 'strategy',
        severity: 0.79,
        bestPractice: 'Define clear positioning statement; validate with customers; differentiate from competitors',
        practicalExplainer: 'Clear positioning helps customers understand why to choose you.',
        standardRefs: 'Positioning (Ries & Trout), Blue Ocean Strategy, Geoffrey Moore Crossing the Chasm',
...
export const valueCreationQuestions: CEOQuestion[] = [
    ...
    },
    {
        ...
        dimensionKey: 'strategy',
        severity: 0.77,
        bestPractice: 'Build moats through network effects, switching costs, brand, or proprietary tech',
    ...
    },
    {
        ...
        dimensionKey: 'strategy',
        severity: 0.88,
        bestPractice: 'Measure PMF through retention, NPS, and organic growth; aim for >40% "very disappointed" score',
        practicalExplainer: 'Product-market fit means customers love your product enough to grow organically.',
...
export const riskGovernanceQuestions: CEOQuestion[] = [
    {
        ...
        dimensionKey: 'strategy',
        severity: 0.76,
        bestPractice: 'Define risk appetite in key areas (financial, operational, reputational); set thresholds',
    ...
    },
    {
        ...
        practicalExplainer: 'Regular reporting builds trust with stakeholders and ensures accountability.',
