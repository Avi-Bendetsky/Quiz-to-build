...
const questions: ReadinessQuestion[] = [
    ...
    // ==========================================
    {
        ...
        severity: 0.95,
        bestPractice: 'Implement multiple layers of security controls at network, application, and data levels',
        practicalExplainer: 'Defense-in-depth means having multiple security barriers. If one fails, others still protect your system.',
        standardRefs: 'ISO 27001:A.13.1, NIST CSF PR.IP-1, OWASP ASVS V1.2',
        acceptance: 'Architecture diagram shows minimum 3 security layers; penetration test confirms no single point of compromise',
        helpText: 'Consider network segmentation, application firewalls, encryption, and access controls',
        orderIndex: 1,
        options: [
    ...
    },
    {
        ...
        practicalExplainer: 'Encryption ensures that even if data is intercepted or stolen, it cannot be read without the keys.',
    ...
    },
    {
        ...
        practicalExplainer: 'Threat modeling helps identify potential attack vectors before they can be exploited.',
    ...
    },
    {
        ...
        dimensionKey: 'arch_sec',
        severity: 0.88,
        bestPractice: 'Validate all inputs server-side using allowlists; sanitize for specific contexts',
    ...
    },
    {
        ...
        dimensionKey: 'arch_sec',
        severity: 0.92,
        bestPractice: 'Use parameterized queries or ORM exclusively; never concatenate user input into SQL',
        practicalExplainer: 'Parameterized queries prevent SQL injection by treating user input as data, not code.',
    ...
    },
    {
        ...
        dimensionKey: 'arch_sec',
        severity: 0.87,
        bestPractice: 'Implement RBAC with roles mapped to business functions; review permissions quarterly',
        practicalExplainer: 'Least privilege means users only have access to what they need for their job.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'CI/CD automates building, testing, and deploying code, reducing human error.',
    ...
    },
    {
        ...
        dimensionKey: 'devops_iac',
        severity: 0.80,
        bestPractice: 'Define all infrastructure using Terraform, Bicep, or Pulumi with version control',
        practicalExplainer: 'IaC makes infrastructure reproducible, auditable, and prevents configuration drift.',
    ...
    },
    {
        ...
        orderIndex: 3,
        options: [
            { id: 'devops-003-1', label: 'Yes, all apps containerized with orchestration', value: 'full' },
    ...
    },
    {
        ...
        practicalExplainer: 'Externalized config allows the same code to run in different environments safely.',
    ...
    },
    {
        ...
        practicalExplainer: 'Rollback capability means you can quickly revert if a deployment causes issues.',
    ...
    },
    {
        ...
        practicalExplainer: 'Integration tests verify that different parts of your system work together.',
    ...
    },
    {
        ...
        practicalExplainer: 'Load testing ensures your system can handle expected traffic without degradation.',
    ...
    },
    {
        ...
        practicalExplainer: 'Accessibility ensures your application is usable by people with disabilities.',
    ...
    },
    {
        ...
        practicalExplainer: 'Automated security testing catches vulnerabilities before they reach production.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'Budget tracking ensures you can complete the project without running out of funds.',
    ...
    },
    {
        ...
        practicalExplainer: 'Cloud costs can spiral quickly; optimization ensures sustainable spending.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'Well-defined user stories ensure developers build what users actually need.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'Data architecture documentation helps with compliance and system understanding.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'Privacy compliance protects users and avoids significant regulatory fines.',
    ...
    },
    {
        ...
        practicalExplainer: 'Incident response procedures ensure quick resolution when things go wrong.',
    ...
    },
    {
        ...
        practicalExplainer: 'Audit logs provide evidence for compliance audits and forensic investigations.',
    ...
    // ==========================================
    {
        ...
        practicalExplainer: 'Training ensures the team has the skills to deliver and maintain the system.',
    ...
    },
    {
        ...
        practicalExplainer: 'Knowledge transfer reduces bus factor risk and helps onboard new team members.',
