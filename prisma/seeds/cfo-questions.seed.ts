...
export const unitEconomicsQuestions: CFOQuestion[] = [
    {
        ...
        practicalExplainer: 'CAC tells you how much you spend to acquire each customer, critical for profitability.',
    ...
    },
    {
        ...
        acceptance: 'MRR dashboard with new/expansion/contraction/churn breakdown; daily/weekly tracking',
        orderIndex: 6,
        options: [
    ...
    },
    {
        ...
        acceptance: 'Pricing strategy documented; competitive analysis complete; pricing experiments run',
        orderIndex: 9,
        options: [
...
export const runwayQuestions: CFOQuestion[] = [
    ...
    },
    {
        ...
        dimensionKey: 'finance',
        severity: 0.86,
        bestPractice: 'Identify cost reduction levers; maintain investor relationships; have bridge options',
...
export const spendGovernanceQuestions: CFOQuestion[] = [
    ...
    },
    {
        ...
        practicalExplainer: 'Tracking contracts prevents unwanted auto-renewals and enables negotiation.',
    ...
    },
    {
        ...
        dimensionKey: 'finance',
        severity: 0.76,
        bestPractice: 'Assign budget owners; monthly budget vs. actual reviews; variance accountability',
    ...
    },
    {
        ...
        dimensionKey: 'finance',
        severity: 0.84,
        bestPractice: 'Reconcile bank accounts monthly; AR/AP reconciliation; close books within 10 days',
    ...
    },
    {
        ...
        dimensionKey: 'finance',
        severity: 0.80,
        bestPractice: 'Separate request, approval, and execution roles; require dual signatures for large payments',
        practicalExplainer: 'Segregation of duties prevents fraud by requiring multiple people for transactions.',
