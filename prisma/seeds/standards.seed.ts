...
const ENGINEERING_STANDARDS: StandardData[] = [
  {
    ...
    description: 'Architectural principles for building scalable, maintainable, and cloud-native systems.',
    principles: [
      {
        title: 'Modular Monoliths & Right-Sized Services',
        description: 'Favor "right-sized" services determined by business boundaries over extreme microservices to reduce operational complexity.',
        examples: ['Domain-driven design bounded contexts', 'Vertical slice architecture'],
      },
      {
        title: 'Cloud-Native Foundations',
        description: 'Use Infrastructure as Code (IaC) and containers (e.g., Kubernetes) to ensure reproducible and elastic environments.',
        examples: ['Terraform/Pulumi for IaC', 'Docker containers', 'Kubernetes orchestration'],
      },
      {
        title: 'Modular Design',
        description: 'Build loosely coupled, independently deployable components with clear API contracts.',
        examples: ['OpenAPI/Swagger specifications', 'Event-driven architecture', 'Clean architecture layers'],
      },
      {
        title: 'Design Before Coding',
        description: 'Create system context diagrams, API contracts, and data topologies before starting implementation.',
  ...
  },
  {
    ...
    description: 'Best practices for integrating AI tools into the development workflow while maintaining quality and security.',
    principles: [
      {
        title: 'AI as a Partner',
        description: 'Integrate AI-powered coding assistants into IDEs for code completion, refactoring suggestions, and test generation.',
        examples: ['GitHub Copilot', 'Cursor', 'Claude for code review'],
      },
      {
        title: 'Multi-Agent Systems (MAS)',
        description: 'Utilize networks of specialized AI agents to automate entire workflows, such as one agent for monitoring and another for code review.',
        examples: ['Automated PR reviews', 'Intelligent test generation', 'Documentation agents'],
      },
      {
        title: 'Human-in-the-Loop Validation',
        description: 'Maintain human review for all AI-generated code to prevent licensing, security, and logic errors.',
  ...
  },
  {
    ...
    principles: [
      ...
      },
      {
        ...
        description: 'Implement only currently required features. Do not build for hypothetical future requirements.',
      ...
      },
      {
        ...
        description: 'Follow Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, and Dependency Inversion.',
        examples: ['One class, one responsibility', 'Program to interfaces', 'Dependency injection'],
      },
      {
  ...
  },
  {
    ...
    principles: [
      ...
      },
      {
        ...
        description: 'Combine unit tests (logic), integration tests (service communication), and end-to-end tests (user flows).',
        examples: ['Testing pyramid', '70/20/10 distribution', 'Contract testing'],
      },
      {
        title: 'Automated Acceptance Tests',
        description: 'Use Behavior-Driven Development (BDD) with "Given-When-Then" language for clarity between developers and stakeholders.',
        examples: ['Cucumber/Gherkin specs', 'Playwright for E2E', 'Cypress for UI testing'],
      },
      {
        title: 'Chaos Engineering',
        description: 'Test the resilience of critical production paths in distributed systems by intentionally introducing failures.',
    ...
    principles: [
      {
        ...
        description: 'Include threat modeling, data classification, and encryption decisions in the initial architecture phase.',
        examples: ['STRIDE threat modeling', 'Data flow diagrams', 'Security requirements'],
      },
      {
        title: 'Automated Security Scanning',
        description: 'Integrate static (SAST) and dynamic (DAST) analysis, plus dependency scanning for known vulnerabilities (CVEs) into CI/CD pipelines.',
      ...
      },
      {
        ...
        examples: ['Encrypted enclaves', 'Secure multi-party computation', 'Homomorphic encryption'],
      },
      {
        title: 'Principle of Least Privilege',
        description: 'Grant only the minimum necessary permissions to users and systems.',
        examples: ['Role-based access control', 'Just-in-time access', 'Service accounts with minimal scope'],
      },
    ],
  },
  {
    ...
    description: 'Operational excellence through automation, observability, and continuous improvement.',
    principles: [
      {
        title: 'CI/CD Maturity',
        description: 'Automate builds, tests, and deployments to achieve a deployment lead time of hours rather than days.',
        examples: ['GitHub Actions', 'GitLab CI', 'ArgoCD for GitOps'],
      },
      {
        title: 'Observability First',
        description: 'Instrument code with logging, tracing, and metrics to ensure internal states can be understood without deploying new code.',
        examples: ['OpenTelemetry', 'Structured logging', 'Distributed tracing'],
      },
      {
        title: 'FinOps & Sustainability',
        description: 'Monitor cloud resource usage to optimize for both cost (FinOps) and carbon footprint (GreenOps).',
        examples: ['Cost allocation tags', 'Right-sizing recommendations', 'Carbon-aware computing'],
      },
      {
        title: 'Progressive Delivery',
        description: 'Use feature flags and canary deployments to limit the "blast radius" of new releases.',
  ...
  },
  {
    ...
    description: 'Practices for maintaining living documentation and preserving institutional knowledge.',
    principles: [
      {
        title: 'Docs-as-Code',
        description: 'Store technical documentation (READMEs, ADRs) in the Git repository alongside the code.',
        examples: ['Markdown in repo', 'Generated API docs', 'Versioned documentation'],
      },
      {
        title: 'Document the "Why"',
        description: 'Focus on explaining design reasoning and business logic rather than obvious implementation details.',
        examples: ['Architecture Decision Records', 'Code comments explaining intent', 'Design documents'],
      },
      {
        title: 'Architecture Decision Records (ADRs)',
        description: 'Track why specific technical choices were made to prevent knowledge loss in distributed teams.',
...
export async function seedStandards(): Promise<void> {
  ...
  for (const standardData of ENGINEERING_STANDARDS) {
    const standard = await prisma.engineeringStandard.upsert({
      ...
      update: {
        ...
        principles: standardData.principles,
      },
      create: {
  ...
  for (const [slug, docData] of Object.entries(CTO_DOCUMENT_MAPPINGS)) {
    ...
    console.log(`  Created/updated document type: ${docData.name} with ${docData.standards.length} standards`);
  }
