...
export async function seedBusinessIncubator() {
    ...
    const questionnaire = await prisma.questionnaire.create({
        data: {
            ...
            description: 'Comprehensive business planning questionnaire that guides entrepreneurs through detailed business planning, generating professional CTO, BA, CFO, and SEO documentation for building online platforms and starting businesses.',
            industry: 'startup',
            version: 1,
            isDefault: true,
            isActive: true,
                            ...
                            create: [
                                {
                                    ...
                                    metadata: {
                                        outputMapping: ['business_plan.company_name', 'all_documents.header.company_name']
                                    }
                                },
                                {
                                    ...
                                    orderIndex: 1,
                                    options: [
                                        { id: 'existing', label: 'Existing business (operating)', description: 'Business is currently operational with customers/revenue' },
                                        { id: 'startup', label: 'New startup (pre-launch)', description: 'Brand new venture, not yet launched to market' },
                                        { id: 'pivot', label: 'Existing business pivoting to new product', description: 'Established company launching new product line' },
                                        { id: 'internal', label: 'Internal project within larger organization', description: 'Corporate initiative or internal tool' }
                                    ],
                                    metadata: {
                                ...
                                },
                                {
                                    ...
                                    options: [
                                        { id: 'sole_prop', label: 'Sole Proprietorship', description: 'Single owner, simple structure' },
                                        { id: 'llc', label: 'Limited Liability Company (LLC)', description: 'Flexible structure, limited liability' },
                                        { id: 'c_corp', label: 'C Corporation', description: 'Separate tax entity, ideal for investors' },
                                        { id: 's_corp', label: 'S Corporation', description: 'Pass-through taxation, ownership restrictions' },
                                        { id: 'partnership', label: 'Partnership', description: 'Multiple owners sharing profits/losses' },
                                        { id: 'nonprofit', label: 'Non-Profit Organization', description: 'Tax-exempt, mission-driven' },
                                        { id: 'undecided', label: 'Not yet decided', description: 'Still evaluating options' }
                                    ],
                                    metadata: {
                                ...
                                },
                                {
                                    ...
                                    isRequired: true,
                                    orderIndex: 5,
                                    helpText: 'This will be used in your executive summary - keep it clear and compelling',
                                ...
                                },
                                {
                                    ...
                                    isRequired: true,
                                    orderIndex: 6,
                                    helpText: 'Explain your products/services, target market, and value proposition in detail',
                                    ...
                                    metadata: {
                                        outputMapping: ['business_plan.company_description.overview', 'brd.business_overview']
                                    }
                                },
                                {
                                    ...
                                    isRequired: false,
                                    orderIndex: 7,
                                    helpText: 'Your mission defines WHY your company exists and what you aim to achieve',
                                ...
                                },
                                {
                                    ...
                                    options: [
                                        ...
                                        { id: 'sustainability', label: 'Sustainability & Social Responsibility', icon: '🌍' },
                            ...
                            create: [
                                {
                                    ...
                                    options: [
                                        { id: 'software_saas', label: 'Software as a Service (SaaS)', description: 'Cloud-based subscription software', icon: '☁️' },
                                        { id: 'mobile_app', label: 'Mobile Application', description: 'iOS/Android native or hybrid app', icon: '📱' },
                                        { id: 'web_app', label: 'Web Application', description: 'Browser-based application', icon: '🌐' },
                                        { id: 'marketplace', label: 'Marketplace Platform', description: 'Two-sided or multi-sided marketplace', icon: '🏪' },
                                        { id: 'ecommerce', label: 'E-commerce Store', description: 'Online retail platform', icon: '🛒' },
                                        { id: 'api_platform', label: 'API/Developer Platform', description: 'B2D (Business to Developer) platform', icon: '🔌' },
                                        { id: 'consulting', label: 'Consulting/Professional Services', description: 'Service-based business', icon: '💼' },
                                        { id: 'physical_product', label: 'Physical Product', description: 'Tangible goods', icon: '📦' },
                                        { id: 'hybrid', label: 'Hybrid (Product + Service)', description: 'Combination of products and services', icon: '🔄' },
                                ...
                                },
                                {
                                    ...
                                    metadata: {
                                        outputMapping: ['business_plan.competitive_advantage', 'brd.unique_value_proposition']
                                    }
                                },
                                {
                            ...
                            create: [
                                {
                                    ...
                                    orderIndex: 0,
                                    options: [
                                        { id: 'b2c', label: 'B2C - Individual Consumers', description: 'Direct to consumer products/services' },
                                        { id: 'b2b_smb', label: 'B2B - Small/Medium Businesses', description: 'Businesses with <500 employees' },
                                        { id: 'b2b_enterprise', label: 'B2B - Enterprise', description: 'Large corporations (500+ employees)' },
                                        { id: 'b2g', label: 'B2G - Government', description: 'Government agencies and institutions' },
                                        { id: 'b2b2c', label: 'B2B2C - Hybrid', description: 'Businesses serving end consumers' }
                                    ],
                                    metadata: {
                                ...
                                },
                                {
                                    ...
                                    metadata: {
                                        outputMapping: ['business_plan.target_market.customer_profile', 'marketing_strategy.customer_persona']
                                    }
                                },
                                {
    ...
    console.log(`📊 Total sections created: ${await prisma.section.count({ where: { questionnaireId: questionnaire.id } })}`);
    console.log(`❓ Total questions created: ${await prisma.question.count({ where: { section: { questionnaireId: questionnaire.id } } })}`);
