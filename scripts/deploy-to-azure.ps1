...
Write-Host "  Health Check: " -NoNewline; Write-Success "https://$APP_URL/health"
Write-Host "  API v1:       " -NoNewline; Write-Success "https://$APP_URL/api/v1"
Write-Host "  Swagger Docs: " -NoNewline; Write-Success "https://$APP_URL/docs"
Write-Host ""
...
Write-Host "  1. Test the API: curl https://$APP_URL/health"
