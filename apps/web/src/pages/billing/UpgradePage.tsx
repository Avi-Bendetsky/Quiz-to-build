...
import { billingApi, type SubscriptionTier, type Subscription } from '../../api/billing';
...
function PricingCard({
    ...
    const isDowngrade = currentTier === 'ENTERPRISE' || (currentTier === 'PROFESSIONAL' && tier === 'FREE');
                ...
                <div className="mt-16 text-center">
                    ...
                    <div className="max-w-3xl mx-auto grid gap-6 text-left">
                        ...
                        <div className="bg-white rounded-lg p-6 shadow-sm">
                            ...
                            <p className="mt-2 text-gray-600">
                                The Free tier allows you to try Quiz2Biz with limited features. You can upgrade when you're
                                ready to access more capabilities.
                            </p>
                        </div>
                    </div>
                </div>
