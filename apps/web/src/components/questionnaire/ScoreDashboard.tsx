...
export const ScoreDashboard: React.FC<ScoreDashboardProps> = ({
    ...
    const progress: SessionProgress = useMemo(() => {
        ...
        return {
            ...
            sectionsCompleted: scoreData.dimensions.filter((d) => d.answeredCount === d.questionCount).length,
    ...
    useEffect(() => {
        ...
        const interval = setInterval(refreshScore, refreshInterval);
        ...
        <div className="score-dashboard space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white">
                    ...
                    <div className="relative">
                        ...
                        <svg className="w-48 h-48 transform -rotate-90">
                            ...
                            <circle
                                ...
                                style={{
                                    stroke: scoreData.score >= 80 ? '#22C55E' :
                                        scoreData.score >= 60 ? '#EAB308' :
                                            scoreData.score >= 40 ? '#F97316' : '#EF4444',
                                }}
                            />
                        </svg>
                        {/* Score text in center */}
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className={`text-5xl font-bold ${getScoreColor(scoreData.score).replace('text-', 'text-white/')}`}>
                ...
                <div className="grid grid-cols-3 gap-4 mt-8">
                    ...
                    <div className="text-center">
                        <p className="text-3xl font-bold">{Math.round((1 - scoreData.portfolioResidual) * 100)}%</p>
