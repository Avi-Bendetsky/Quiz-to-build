...
describe('ScoreDashboard', () => {
    const mockScore = {
        ...
        dimensions: [
            { key: 'requirements', name: 'Requirements', weight: 0.3, residualRisk: 0.1, questionCount: 10, answeredCount: 10, averageCoverage: 0.9 },
            { key: 'architecture', name: 'Architecture', weight: 0.3, residualRisk: 0.2, questionCount: 10, answeredCount: 8, averageCoverage: 0.8 },
            { key: 'security', name: 'Security', weight: 0.4, residualRisk: 0.6, questionCount: 10, answeredCount: 5, averageCoverage: 0.5 },
        ],
        totalQuestions: 30,
    ...
    it('shows refresh button when onRefresh provided', () => {
        render(<ScoreDashboard initialScore={mockScore} sessionId="session-1" onRefresh={mockOnRefresh} />);
