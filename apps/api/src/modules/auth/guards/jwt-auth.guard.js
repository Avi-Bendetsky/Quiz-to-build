...
var JwtAuthGuard = function () {
    ...
    var _classSuper = (0, passport_1.AuthGuard)('jwt');
    var JwtAuthGuard = _classThis = /** @class */ (function (_super) {
        __extends(JwtAuthGuard_2, _super);
        function JwtAuthGuard_2(reflector) {
            var _this = _super.call(this) || this;
            _this.reflector = reflector;
            return _this;
        }
        JwtAuthGuard_2.prototype.canActivate = function (context) {
            var isPublic = this.reflector.getAllAndOverride(public_decorator_1.IS_PUBLIC_KEY, [
                context.getHandler(),
                context.getClass(),
            ]);
        ...
        JwtAuthGuard_2.prototype.handleRequest = function (err, user, info) {
            if (err || !user) {
                if ((info === null || info === void 0 ? void 0 : info.name) === 'TokenExpiredError') {
                    throw new common_1.UnauthorizedException('Token has expired');
                }
