...
exports.RefreshResponseDto = exports.TokenResponseDto = exports.UserResponseDto = void 0;
...
var UserResponseDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _id_decorators = [(0, swagger_1.ApiProperty)({ example: 'usr_abc123' })];
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'user@example.com' })];
            _role_decorators = [(0, swagger_1.ApiProperty)({ enum: client_1.UserRole, example: 'CLIENT' })];
            _name_decorators = [(0, swagger_1.ApiProperty)({ example: 'John Doe', required: false })];
...
var TokenResponseDto = function () {
    ...
    return _a = /** @class */ (function () {
            function TokenResponseDto() {
                ...
                this.expiresIn = (__runInitializers(this, _refreshToken_extraInitializers), __runInitializers(this, _expiresIn_initializers, void 0));
                this.tokenType = (__runInitializers(this, _expiresIn_extraInitializers), __runInitializers(this, _tokenType_initializers, void 0));
                this.user = (__runInitializers(this, _tokenType_extraInitializers), __runInitializers(this, _user_initializers, void 0));
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _accessToken_decorators = [(0, swagger_1.ApiProperty)({ example: 'eyJhbGciOiJIUzI1NiIs...' })];
            _refreshToken_decorators = [(0, swagger_1.ApiProperty)({ example: 'dGhpcyBpcyBhIHJlZnJlc2g...' })];
            _expiresIn_decorators = [(0, swagger_1.ApiProperty)({ example: 900, description: 'Token expiration time in seconds' })];
            _tokenType_decorators = [(0, swagger_1.ApiProperty)({ example: 'Bearer' })];
            _user_decorators = [(0, swagger_1.ApiProperty)({ type: UserResponseDto })];
...
var RefreshResponseDto = function () {
    ...
    return _a = /** @class */ (function () {
            function RefreshResponseDto() {
                this.accessToken = __runInitializers(this, _accessToken_initializers, void 0);
                this.expiresIn = (__runInitializers(this, _accessToken_extraInitializers), __runInitializers(this, _expiresIn_initializers, void 0));
