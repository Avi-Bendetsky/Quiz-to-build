...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getMe = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.findById(user.id)];
                });
            });
        };
        UsersController_1.prototype.updateMe = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.update(user.id, dto, user.id)];
                });
            });
        };
        UsersController_1.prototype.findAll = function (pagination, role) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, items, total;
                var _b, _c, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0: return [4 /*yield*/, this.usersService.findAll(pagination, role)];
                        case 1:
    ...
    (function () {
        ...
        _getMe_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiOperation)({ summary: 'Get current user profile' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Current user profile' })];
        _updateMe_decorators = [(0, common_1.Put)('me'), (0, swagger_1.ApiOperation)({ summary: 'Update current user profile' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Updated user profile' })];
        _findAll_decorators = [(0, common_1.Get)(), (0, common_1.UseGuards)(roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), (0, swagger_1.ApiOperation)({ summary: 'List all users (Admin only)' }), (0, swagger_1.ApiQuery)({ name: 'role', enum: client_1.UserRole, required: false }), (0, swagger_1.ApiResponse)({ status: 200, description: 'List of users' })];
        _findById_decorators = [(0, common_1.Get)(':id'), (0, common_1.UseGuards)(roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), (0, swagger_1.ApiOperation)({ summary: 'Get user by ID (Admin only)' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'User profile' }), (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' })];
...
var UsersController = function () {
    ...
    var _findById_decorators;
    var UsersController = _classThis = /** @class */ (function () {
        function UsersController_2(usersService) {
            this.usersService = (__runInitializers(this, _instanceExtraInitializers), usersService);
        }
        UsersController_2.prototype.getMe = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.findById(user.id)];
                });
        ...
        UsersController_2.prototype.updateMe = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.update(user.id, dto, user.id)];
                });
        ...
        UsersController_2.prototype.findAll = function (pagination, role) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, items, total;
                var _b, _c, _d;
                return __generator(this, function (_e) {
        ...
        UsersController_2.prototype.findById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.findById(id)];
                });
