...
var UsersService = function () {
    ...
    var _classThis;
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_2(prisma) {
            this.prisma = prisma;
        }
        UsersService_2.prototype.findById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var user, documentsCount;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_2.prototype.update = function (id, dto, requestingUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, updateData, currentProfile, currentPrefs, updatedUser, documentsCount;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersService_2.prototype.findAll = function (pagination, role) {
            return __awaiter(this, void 0, void 0, function () {
                var where, _a, users, total, items;
                var _this = this;
                return __generator(this, function (_b) {
        ...
        UsersService_2.prototype.mapToUserProfile = function (user, documentsCount) {
            var _a;
            var profile = user.profile || {};
            var preferences = user.preferences || {};
            return {
