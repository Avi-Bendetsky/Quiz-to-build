...
describe('QpgService', () => {
    ...
    describe('generatePromptsForSession', () => {
        it('generates prompts for all gaps', async () => {
            ...
            jest.spyOn(templateService, 'getTemplateForDimension').mockResolvedValue({ id: 'template-1' } as any);
            jest.spyOn(promptGenerator, 'generate').mockResolvedValueOnce(mockPrompts[0]).mockResolvedValueOnce(mockPrompts[1]);
