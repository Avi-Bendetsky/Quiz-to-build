    ...
    private initializeDefaultTemplates(): void {
        const defaultTemplates: PromptTemplate[] = [
            // Architecture & Security (weight: 0.15)
            {
                ...
                version: '1.0.0',
                goalTemplate: 'Implement {{bestPractice}} to address the security/architecture gap in {{dimensionName}}',
                taskTemplates: [
                    { order: 1, template: 'Review current {{dimensionName}} implementation against {{standardRefs}}' },
            ...
            // Requirements (weight: 0.08)
            {
                ...
                defaultConstraints: [
                    'Must follow standard templates',
