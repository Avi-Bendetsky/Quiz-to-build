...
export class AdapterController {
    ...
    @ApiQuery({ name: 'type', required: false, enum: ['github', 'gitlab', 'jira', 'confluence', 'azure_devops'] })
        ...
        try {
            ...
            switch (config.type) {
                ...
                case 'confluence': {
                    ...
                    const confluenceConfig = config.type === 'confluence' || atlassianConfig.spaceKey
                        ? {
    ...
    private redactSensitiveFields(config: AdapterConfig): AdapterConfig {
        ...
        const sensitiveFields = ['token', 'apiToken', 'personalAccessToken', 'webhookSecret', 'webhookToken'];
