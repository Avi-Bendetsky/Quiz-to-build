...
describe('EvidenceIntegrityService', () => {
    ...
    describe('chainEvidence', () => {
        ...
        it('throws NotFoundException for non-existent evidence', async () => {
            ...
            await expect(service.chainEvidence('non-existent', 'session-456')).rejects.toThrow(NotFoundException);
        });
    ...
    describe('verifyEvidenceIntegrity', () => {
        ...
        it('throws NotFoundException for non-existent evidence', async () => {
            ...
            await expect(service.verifyEvidenceIntegrity('non-existent')).rejects.toThrow(NotFoundException);
        });
    });
