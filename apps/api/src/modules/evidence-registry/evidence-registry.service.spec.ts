...
describe('EvidenceRegistryService', () => {
    ...
    describe('verifyEvidence', () => {
        it('verifies evidence and sets verifier', async () => {
            ...
            const updatedEvidence = { ...mockEvidence, verified: true, verifierId: 'verifier-999', verifiedAt: new Date() };
        ...
        it('unverifies evidence and clears verifier', async () => {
            ...
            const updatedEvidence = { ...mockEvidence, verified: false, verifierId: null, verifiedAt: null };
    ...
    describe('deleteEvidence', () => {
        ...
        it('prevents deletion of verified evidence', async () => {
            ...
            await expect(service.deleteEvidence('evidence-123', 'user-999')).rejects.toThrow(ForbiddenException);
        ...
        it('throws NotFoundException for non-existent evidence', async () => {
            ...
            await expect(service.deleteEvidence('non-existent', 'user-999')).rejects.toThrow(NotFoundException);
        });
    });

    describe('bulkVerifyEvidence', () => {
        it('verifies multiple evidence items successfully', async () => {
            const mockEvidence1 = { id: 'evidence-1', sessionId: 's1', questionId: 'q1', verified: false } as any;
            const mockEvidence2 = { id: 'evidence-2', sessionId: 's1', questionId: 'q2', verified: false } as any;
        ...
        it('handles partial failures gracefully', async () => {
            ...
            mockPrisma.evidenceRegistry.update.mockResolvedValue({ id: 'evidence-1', verified: true } as any);
