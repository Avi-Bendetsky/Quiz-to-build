...
import { SubscriptionResponseDto, SubscriptionTierDto, SubscriptionStatusDto } from './dto/payment.dto';
...
export class SubscriptionService {
    ...
    async syncSubscriptionStatus(params: SyncSubscriptionParams): Promise<void> {
        this.logger.log(
            `Syncing subscription ${params.stripeSubscriptionId}, status ${params.status}`,
        );
     ...
     */
    compareTiers(currentTier: SubscriptionTier, newTier: SubscriptionTier): 'upgrade' | 'downgrade' | 'same' {
