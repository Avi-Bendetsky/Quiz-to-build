...
export const BUSINESS_PLAN_TEMPLATE = {
    ...
    description: 'Comprehensive business planning document covering strategy, operations, financials, and growth plans',
    estimatedPages: 25,
    ...
    sections: [
        ...
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'company_overview', title: 'Company Overview', contentPath: 'executiveSummary.companyDescription' },
                { id: 'mission_vision', title: 'Mission & Vision', contentPath: 'executiveSummary.missionStatement' },
                { id: 'business_opportunity', title: 'Business Opportunity', contentPath: 'executiveSummary.businessOpportunity' },
                { id: 'competitive_advantage', title: 'Competitive Advantage', contentPath: 'executiveSummary.competitiveAdvantage' },
                { id: 'financial_highlights', title: 'Financial Highlights', contentPath: 'executiveSummary.financialHighlights' },
            ],
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'legal_structure', title: 'Legal Structure', contentPath: 'companyDescription.legalStructure' },
                { id: 'ownership', title: 'Ownership Structure', contentPath: 'companyDescription.ownershipStructure' },
                { id: 'history', title: 'Company History', contentPath: 'companyDescription.companyHistory' },
                { id: 'location', title: 'Location', contentPath: 'companyDescription.location' },
                { id: 'industry', title: 'Industry Overview', contentPath: 'companyDescription.industryOverview' },
            ],
        },
        {
            id: 'market_analysis',
            ...
            required: true,
            subsections: [
                { id: 'industry_desc', title: 'Industry Description', contentPath: 'marketAnalysis.industryDescription' },
                { id: 'market_size', title: 'Target Market Size', contentPath: 'marketAnalysis.targetMarketSize' },
                { id: 'segmentation', title: 'Market Segmentation', contentPath: 'marketAnalysis.marketSegmentation' },
                { id: 'competitors', title: 'Competitor Analysis', contentPath: 'marketAnalysis.competitorAnalysis' },
        ...
        },
        {
            ...
            subsections: [
                ...
                { id: 'ip', title: 'Intellectual Property', contentPath: 'productsServices.intellectualProperty' },
                { id: 'rd', title: 'Research & Development', contentPath: 'productsServices.researchDevelopment' },
            ],
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'positioning', title: 'Market Positioning', contentPath: 'marketingStrategy.positioning' },
                { id: 'pricing', title: 'Pricing Strategy', contentPath: 'marketingStrategy.pricingStrategy' },
                { id: 'distribution', title: 'Distribution Channels', contentPath: 'marketingStrategy.distributionChannels' },
                { id: 'promotion', title: 'Promotional Strategy', contentPath: 'marketingStrategy.promotionalStrategy' },
        ...
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'production', title: 'Production/Service Delivery', contentPath: 'operationsPlan.productionProcess' },
                { id: 'facilities', title: 'Facilities & Equipment', contentPath: 'operationsPlan.facilitiesEquipment' },
                { id: 'technology', title: 'Technology & Systems', contentPath: 'operationsPlan.technologySystems' },
        ...
        },
        {
            ...
            subsections: [
                ...
                { id: 'org_structure', title: 'Organization Structure', contentPath: 'managementTeam.organizationStructure' },
                { id: 'advisory', title: 'Advisory Board', contentPath: 'managementTeam.advisoryBoard' },
                { id: 'hr_plan', title: 'Human Resources Plan', contentPath: 'managementTeam.humanResourcesPlan' },
            ],
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'revenue_model', title: 'Revenue Model', contentPath: 'financialProjections.revenueModel' },
                { id: 'income_projections', title: 'Projected Income Statement', contentPath: 'financialProjections.projectedIncome' },
                { id: 'cash_flow', title: 'Cash Flow Projections', contentPath: 'financialProjections.projectedCashFlow' },
                { id: 'break_even', title: 'Break-Even Analysis', contentPath: 'financialProjections.breakEvenAnalysis' },
                { id: 'funding', title: 'Funding Requirements', contentPath: 'financialProjections.fundingRequirements' },
                { id: 'assumptions', title: 'Financial Assumptions', contentPath: 'financialProjections.financialAssumptions' },
            ],
        },
        {
            id: 'risk_management',
            ...
            subsections: [
                ...
                { id: 'mitigation', title: 'Mitigation Strategies', contentPath: 'riskManagement.mitigationStrategies' },
                { id: 'contingency', title: 'Contingency Plans', contentPath: 'riskManagement.contingencyPlans' },
                { id: 'insurance', title: 'Insurance Requirements', contentPath: 'riskManagement.insuranceRequirements' },
            ],
        },
        {
            id: 'appendices',
            ...
            required: false,
            subsections: [
                { id: 'financials', title: 'Financial Statements', contentPath: 'appendices.financialStatements' },
                { id: 'market_research', title: 'Market Research', contentPath: 'appendices.marketResearch' },
