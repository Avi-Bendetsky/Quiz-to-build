...
export const TECHNOLOGY_ROADMAP_TEMPLATE = {
    ...
    description: 'Strategic technology planning document outlining current state, future vision, and implementation roadmap',
    estimatedPages: 15,
    ...
    sections: [
        ...
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'tech_stack', title: 'Current Technology Stack', contentPath: 'currentState.techStack' },
                { id: 'infrastructure', title: 'Infrastructure Overview', contentPath: 'currentState.infrastructure' },
                { id: 'pain_points', title: 'Pain Points & Challenges', contentPath: 'currentState.painPoints' },
                { id: 'technical_debt', title: 'Technical Debt Analysis', contentPath: 'currentState.technicalDebt' },
            ],
        },
        {
            id: 'future_vision',
            ...
            required: true,
            subsections: [
                { id: 'business_goals', title: 'Business Goals Alignment', contentPath: 'futureState.businessGoals' },
                { id: 'tech_vision', title: 'Technology Vision', contentPath: 'futureState.techVision' },
                { id: 'target_architecture', title: 'Target Architecture', contentPath: 'futureState.targetArchitecture' },
                { id: 'scalability', title: 'Scalability Requirements', contentPath: 'futureState.scalabilityRequirements' },
            ],
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'short_term', title: 'Short-Term (0-6 months)', contentPath: 'initiatives.shortTerm' },
                { id: 'medium_term', title: 'Medium-Term (6-18 months)', contentPath: 'initiatives.mediumTerm' },
        ...
        },
        {
            ...
            required: true,
            subsections: [
                { id: 'technical_risks', title: 'Technical Risks', contentPath: 'riskAssessment.technicalRisks' },
                { id: 'mitigation', title: 'Mitigation Strategies', contentPath: 'riskAssessment.mitigationStrategies' },
            ],
        },
        {
            id: 'timeline',
