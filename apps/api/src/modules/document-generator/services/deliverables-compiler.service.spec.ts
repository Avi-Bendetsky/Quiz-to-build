...
describe('DeliverablesCompilerService', () => {
    ...
    describe('compileDeliverablesPack', () => {
        ...
        it('includes Observability document', async () => {
            ...
            const obsDoc = result.documents.find(
                (d) => d.category === DeliverableCategory.OBSERVABILITY,
            );
        ...
        it('includes Policy Pack when enabled', async () => {
            ...
            const policyDoc = result.documents.find(
                (d) => d.category === DeliverableCategory.GOVERNANCE,
            );
        ...
        it('throws NotFoundException for non-existent session', async () => {
            ...
            await expect(
                service.compileDeliverablesPack('non-existent', 'user-456'),
