...
exports.ApproveDocumentDto = exports.RejectDocumentDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var RejectDocumentDto = function () {
    var _a;
    var _reason_decorators;
    var _reason_initializers = [];
    var _reason_extraInitializers = [];
    return _a = /** @class */ (function () {
            function RejectDocumentDto() {
        ...
        (function () {
            ...
            _reason_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(1000)];
...
var ApproveDocumentDto = function () {
    var _a;
    var _notes_decorators;
    var _notes_initializers = [];
    var _notes_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ApproveDocumentDto() {
