...
export class CompileDeliverablesDto {
  ...
  @ApiPropertyOptional({ description: 'Enable auto-sectioning (≤1000 words per section)', default: true })
  @IsOptional()
  @IsBoolean()
  autoSection?: boolean;
...
export class CompiledDocumentDto {
  ...
  @ApiProperty({ enum: ['ARCHITECTURE', 'SDLC', 'TESTING', 'DEVSECOPS', 'PRIVACY', 'OBSERVABILITY', 'FINANCE', 'GOVERNANCE', 'READINESS'] })
  category: string;
